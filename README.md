...
```javascript
import factory from 'https://cdn.jsdelivr.net/gh/stdlib-js/math-tools-unary@v0.3.0-esm/index.mjs';
```
...
import ndarray2array from 'https://cdn.jsdelivr.net/gh/stdlib-js/ndarray-to-array@esm/index.mjs';
import unary from 'https://cdn.jsdelivr.net/gh/stdlib-js/ndarray-base-unary@esm/index.mjs';
import ufunc from 'https://cdn.jsdelivr.net/gh/stdlib-js/math-tools-unary@v0.3.0-esm/index.mjs';
